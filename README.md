...
> **Status**
> This is a foundation-stage open-source repository. Today you can run local infrastructure, schemas, migrations, service foundations, `aedo-cli` scaffolding, and a Command Center shell backed by mock data. Full registry admission control and end-to-end analysis workflows are still phase-gated work in progress.
...
If you want a quick smoke test of the repository as it exists today:
